...
{
    public class WhenEmailFailedMoreThanMaxRetries : EmailQueueProjectionSpecification<Projections.Emails.EmailQueueProjection>
    {
        ...
        protected override IEnumerable<IEvent> Given()
        {
            ...
            {
                yield return new EmailFailed(_aggregateId, i + 2, "");
            }
        }
